...
export function PreviewProgramCard({
  ...
  return (
    ...
    >
      ...
      {/* <div className={`text-lg text-end p-2 text-[${accentColor}]`}>{formatLabel(titleText)}</div> */}
                ...
                return (
                  <div
                    ...
                    className={`h-9 rounded-md transition-all ${
                      isActive ? "bg-[#3b82f6] shadow-sm shadow-blue-500/40" : "bg-[#292b31]"
                    }`}
                  />
                );
              })}

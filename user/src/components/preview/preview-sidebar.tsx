...
const NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    icon: Banknote,
    items: [
      { to: "/preview/magic-gold-matrix", label: "Magic Gold Matrix", icon: Gem  },
      { to: "/preview/sponsor-magic", label: "Sponsor Magic", icon: GitBranch },
...
export function PreviewSidebar({ onNavigate }: Props) {
  ...
  return (
    ...
    {/* <aside className="flex h-full w-52 shrink-0 flex-col bg-[#16161700] pt-4 pr-3 text-[#A1A1A6] font-sans"> */}

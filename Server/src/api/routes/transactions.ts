...
// (joins user_registrations twice). Income types only, no purchases (dropped
// per explicit request — purchases are noise on this card); admin (YF00001,
// memberId=1) excluded on both sides too — admin routinely receives
...
// held-events/purchases are in the per-wallet feed (/:address) but not here.
